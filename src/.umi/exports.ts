...
// plugins
export { connect, useDispatch, useStore, useSelector, getDvaApp } from 'D:/RND/inventory-umi/src/.umi/plugin-dva';
export { addLocale, setLocale, getLocale, getIntl, useIntl, injectIntl, formatMessage, FormattedMessage, getAllLocales, FormattedDate, FormattedDateParts, FormattedDisplayName, FormattedHTMLMessage, FormattedList, FormattedNumber, FormattedNumberParts, FormattedPlural, FormattedRelativeTime, FormattedTime, FormattedTimeParts, IntlProvider, RawIntlProvider, SelectLang } from 'D:/RND/inventory-umi/src/.umi/plugin-locale';
export { Provider, useModel } from 'D:/RND/inventory-umi/src/.umi/plugin-model';
export { useRequest, UseRequestProvider, request, getRequestInstance } from 'D:/RND/inventory-umi/src/.umi/plugin-request';
// plugins types.d.ts
export * from 'D:/RND/inventory-umi/src/.umi/plugin-antd/types.d';
export * from 'D:/RND/inventory-umi/src/.umi/plugin-dva/types.d';
export * from 'D:/RND/inventory-umi/src/.umi/plugin-layout/types.d';
export * from 'D:/RND/inventory-umi/src/.umi/plugin-request/types.d';
// @umijs/renderer-*
