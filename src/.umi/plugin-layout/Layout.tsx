...
/// <reference types="/Volumes/Projects/Personal/ERP-HUB/inventory-umi/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "/Volumes/Projects/Personal/ERP-HUB/inventory-umi/node_modules/@ant-design/pro-components";
import './Layout.less';
...
const { formatMessage } = useIntl();
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || '@example/ant-design-pro'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
