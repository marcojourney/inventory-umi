...
import type { Datum, OfflineDataType, SearchDataType } from './data.d';
...
const avatars = [
  ...
  'https://gw.alipayobjects.com/zos/rmsportal/sfjbOqnsXXJgNCjCzDBL.png', // ERP HUB
